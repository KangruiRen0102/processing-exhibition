...
void draw() {
  ...
  // Tsunami wave representing the struggles an engineer goes through and how helpless he can feel sometimes
  fill(10, 10, 40);
  beginShape();
  vertex(400, 300);
  vertex(800, 300);
  ...
  // Island of hope behind the tsunami representing all the good things at the end of the journey  that keep up us moving forward
  ...
  // Person on the boat representing an engineering student in his journey
  fill(200, 150, 100);
