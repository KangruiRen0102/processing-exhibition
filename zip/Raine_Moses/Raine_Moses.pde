float circleY = 20; // Height of the circle
float circleD = 20; // Diameter of the circle
float triX;
float triY;
float dim;
float k;
...
void draw() {
  if (circleY < (height-circleD/2) && frameCount < 100) {
    ...
    fill(255, 165, 0);
    noStroke();
    triangle(width/2-circleD/8, circleY-circleD, width/2+circleD/8, circleY-circleD, width/2, circleY-circleD-circleD/4);
...
// --------------------------------------------------------------------------------------------
    ...
    fill(0);
    noStroke();
    triangle(triX-10*k, triY-5*k, triX+10-10*k, triY+10-5*k, triX+10-10*k, triY-10-5*k);
    triangle(triX+5*k, triY-8*k, triX+20+5*k, triY-20-8*k, triX+40+5*k, triY+20-8*k);
    triangle(triX+0*k, triY-9*k, triX+10+0*k, triY-20-9*k, triX+20+0*k, triY+20-9*k);
    triangle(triX-5*k, triY-8*k, triX+20-5*k, triY-20-8*k, triX+30-5*k, triY+20-8*k);
    triangle(triX+10*k, triY-5*k, triX+20+10*k, triY-20-5*k, triX+40+10*k, triY+20-5*k);
...
// --------------------------------------------------------------------------------------------
    ...
    vertex(width/2+40, height/2+80);
    endShape(CLOSE);
    triangle(width/2, height/2, width/2-20, height/2-40, width/2+20, height/2-40);
    stroke(194,178,128);
    strokeWeight(2);
    ...
    fill(255);
    rect(width/2, height/2-90, 100, 20);
    rect(width/2, height/2+90, 100, 20);
