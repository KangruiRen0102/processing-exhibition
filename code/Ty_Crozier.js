...
function drawTrees() {
  ...
  for (let i = 0; i < 20; i++) {
    let x = random(50, 750); // More evenly spread out
    let y = random(height - 300, height - 200);
