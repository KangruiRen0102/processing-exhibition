let deer1X = 300; // X-coordinate of the first deer
let deer2X = 500; // X-coordinate of the second deer
let deer1Y, deer2Y; // Y-coordinates of the deer
let draggingDeer1 = false; // To check if deer1 is being dragged
let draggingDeer2 = false; // To check if deer2 is being dragged
...
function drawTwilightSky() {
  for (let y = 0; y < height; y++) {
    ...
    let c = lerpColor(color(253, 94, 83), color(90, 48, 152), inter);
    stroke(c);
    line(0, y, width, y);
  }
}
...
function drawHometownLandscape() {
